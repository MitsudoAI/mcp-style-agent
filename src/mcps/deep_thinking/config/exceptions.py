...
class AgentExecutionError(DeepThinkingError):
    ...
    def __init__(self, message: str, agent_type: str = None, session_id: str = None, **kwargs):
...
class AgentNotFoundError(DeepThinkingError):
    ...
    def __init__(self, message: str, agent_type: str = None, instance_id: str = None, **kwargs):
        super().__init__(message, **kwargs)
        self.agent_type = agent_type
...
class FlowExecutionError(DeepThinkingError):
    ...
    def __init__(self, message: str, flow_name: str = None, step_id: str = None, **kwargs):
        super().__init__(message, **kwargs)
...
class SearchError(DeepThinkingError):
    ...
    def __init__(self, message: str, query: str = None, search_type: str = None, **kwargs):
        super().__init__(message, **kwargs)
        self.query = query
...
class EvaluationError(DeepThinkingError):
    ...
    def __init__(self, message: str, evaluation_type: str = None, content_id: str = None, **kwargs):
        super().__init__(message, **kwargs)
