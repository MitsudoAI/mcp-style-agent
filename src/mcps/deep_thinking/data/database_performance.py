...
class DatabaseConnection:
    ...
    def _create_connection(self):
        ...
        try:
            ...
            logger.error(f"Failed to create database connection {self.connection_id}: {e}")
            raise
            ...
            try:
                ...
                with self.lock:
                    ...
                    if self.stats.connections_created > 0:
                        total_wait = self.stats.average_wait_time * (self.stats.connections_created - 1)
                        self.stats.average_wait_time = (total_wait + wait_time) / self.stats.connections_created
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self.lock:
            return {
                ...
                "pool_utilization": self.stats.active_connections / max(self.stats.total_connections, 1),
...
class QueryOptimizer:
    ...
    def execute_with_monitoring(self, connection: DatabaseConnection, query: str, params: Tuple = ()) -> sqlite3.Cursor:
        ...
        with self.lock:
            ...
            for query_type, query_stats in self.query_stats.items():
                stats[query_type] = {
                    ...
                    "min_time": query_stats.min_time if query_stats.min_time != float('inf') else 0,
...
class DatabasePerformanceOptimizer:
    ...
    def initialize_after_tables_created(self):
        ...
        try:
            ...
            logger.info("Database performance optimizations initialized after table creation")
        except Exception as e:
            logger.error(f"Failed to initialize database optimizations after table creation: {e}")
...
class IndexOptimizer:
    ...
    def __init__(self):
        ...
        self.recommended_indexes = [
            ...
            ("idx_steps_session_number", "session_steps", ["session_id", "step_number"]),
        ...
        try:
            ...
            for index_name, table_name, columns in self.recommended_indexes:
                if index_name not in existing_indexes:
                    missing_indexes.append(f"{index_name} ON {table_name}({', '.join(columns)})")
...
class DatabasePerformanceMonitor:
    ...
    def analyze_table_stats(self, connection: DatabaseConnection):
        """Analyze table statistics"""
        try:
            tables = ["thinking_sessions", "session_steps", "step_results", "evidence_sources"]
            table_stats = {}
