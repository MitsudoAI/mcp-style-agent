...
class TestFlowExecutorIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.template_manager.get_template = MagicMock(
            return_value="Test template content"
        )
        ...
        # Create test flow
        self.flow_id = self.flow_manager.create_flow(
            "test_session_id", "comprehensive_analysis"
        )
    ...
    def test_error_handling_integration(self):
        ...
        # Test error handling
        error_info = self.flow_executor.handle_error(
            self.flow_id, step.step_id, context.exception
        )
