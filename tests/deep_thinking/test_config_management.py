...
class TestConfigValidator:
    ...
    def test_validate_system_config_invalid_numeric_range(self):
        ...
        assert not is_valid
        assert any("max_concurrent_agents must be between 1 and 100" in error for error in errors)
        assert any("default_timeout must be between 1 and 3600" in error for error in errors)
