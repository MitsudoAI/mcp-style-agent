...
class TestFlowExecutor(unittest.TestCase):
    ...
    def test_execute_flow_with_error(self):
        ...
        with patch.object(self.flow_executor, "execute_step") as mock_execute_step:
            ...
            result = self.flow_executor.execute_flow(
                "test_flow_id", continue_on_error=False
            )
    ...
    def test_execute_flow_continue_on_error(self):
        ...
        with patch.object(self.flow_executor, "execute_step") as mock_execute_step:
            ...
            result = self.flow_executor.execute_flow(
                "test_flow_id", continue_on_error=True
            )
    ...
    def test_template_selection(self):
        ...
        template_name, _ = self.flow_executor._select_template(
            self.flow, self.step, self.flow.context
        )
