...
class TestCriticalEvaluationTemplate:
    ...
    def test_critical_evaluation_template_complexity_adaptation_high(self, template_manager):
    ...
    def test_critical_evaluation_template_complexity_adaptation_medium(self, template_manager):
    ...
    def test_critical_evaluation_template_complexity_adaptation_low(self, template_manager):
