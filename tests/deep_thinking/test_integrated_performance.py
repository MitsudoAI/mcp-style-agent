...
from src.mcps.deep_thinking.performance.integrated_optimizer import IntegratedPerformanceOptimizer
...
class TestIntegratedPerformanceOptimizer:
    ...
    def test_operation_tracking(self, temp_setup):
        ...
        try:
            ...
            if "response_times" in metrics["system_performance"]:
                ...
                assert "test_operation_1" in response_times or "test_operation_2" in response_times
    ...
    def test_concurrent_operations(self, temp_setup):
        ...
        try:
            ...
            metrics = optimizer.get_comprehensive_metrics()
            if "system_performance" in metrics and "response_times" in metrics["system_performance"]:
                response_times = metrics["system_performance"]["response_times"]
                # Should have tracked some concurrent operations
                concurrent_ops = [op for op in response_times.keys() if op.startswith("concurrent_test_")]
...
class TestIntegratedPerformanceWithRealComponents:
    ...
    def test_integration_with_template_manager(self, real_components_setup):
        ...
        template_manager = TemplateManager(templates_dir, enable_performance_optimization=True)
    ...
    def test_integration_with_database(self, real_components_setup):
        ...
        try:
            ...
            cursor = optimizer.execute_database_query("SELECT COUNT(*) FROM thinking_sessions")
