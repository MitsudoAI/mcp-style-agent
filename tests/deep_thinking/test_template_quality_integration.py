...
from mcps.deep_thinking.templates.template_validator import TemplateValidator, ValidationSeverity
...
class TestTemplateQualityIntegration:
    ...
    def test_validate_template_manager_templates(self):
        ...
        for template_name in template_names:
            try:
                ...
                result = self.validator.validate_template(template_content, template_name)
                ...
                print(f"✓ {template_name}: Score {result.overall_score:.2f}, "
        ...
        good_templates = sum(1 for r in validation_results.values() if r.overall_score >= 0.7)
        ...
        assert good_templates / total_templates >= 0.7, \
    ...
    def test_template_parameter_validation_integration(self):
        ...
        try:
            ...
            assert result.overall_score >= 0.8, f"Template {template_name} should have high quality"
            
            # Should detect parameters
            assert result.metrics['parameter_count'] > 0, "Should detect parameters in template"
    ...
    def test_template_validation_with_file_system(self):
        ...
        assert len(common_templates) > 0, "Should have common templates between manager and files"
...
"""
        ...
        serious_issues = [i for i in result.issues 
...
"""
        ...
        assert metrics['effectiveness_score'] > 0.7, "Should have good effectiveness score"
