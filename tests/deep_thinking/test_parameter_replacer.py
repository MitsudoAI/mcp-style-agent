...
class TestParameterReplacer:
    ...
    def configured_replacer(self):
        ...
        replacer.register_parameter_config(ParameterConfig(
            name="required_param",
            required=True,
    ...
    def test_parameter_validation_success(self, configured_replacer):
        ...
        params = {
            ...
            "validated_param": "valid_long_value"
        }
    ...
    def test_parameter_priority(self, replacer):
        ...
        params = {"var": "param"}
        context = ReplacementContext(
            previous_results={"var": "previous"},
            custom_variables={"var": "custom"}
        )
    ...
    def test_custom_validator_registration(self, replacer):
        ...
        replacer.register_validator("is_even", lambda x: isinstance(x, int) and x % 2 == 0)
        
        config = ParameterConfig(
            name="even_number",
            validator=replacer.validators['is_even']
        )
...
"""
    ...
    def test_error_handling_in_formatters(self, replacer):
        ...
        replacer.register_formatter("failing_formatter", lambda x: x.nonexistent_method())
