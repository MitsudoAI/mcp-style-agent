...
"""
        ...
        metrics = self.validator.validate_template_effect(high_quality_template, "high_quality_test")
...
"""
        ...
        metrics = self.validator.validate_template_effect(low_quality_template, "low_quality_test")
...
"""
        ...
        structured_score = self.validator._test_structure_completeness(structured_template, "structured_test")
        unstructured_score = self.validator._test_structure_completeness(unstructured_template, "unstructured_test")
...
"""
        ...
        specific_score = self.validator._test_content_relevance(specific_template, "specific_test")
        vague_score = self.validator._test_content_relevance(vague_template, "vague_test")
