...
try:
    from mcps.deep_thinking.models.mcp_models import (
        NextStepInput, MCPToolOutput, MCPToolName, SessionState, StartThinkingInput
    )
    ...
    class MockFlowManager:
        def get_next_step(self, flow_type, current_step, result):
            return {"step_name": "evidence", "template_name": "evidence_collection", "instructions": "Test"}
...
class TestNextStepTool:
    ...
    def test_next_step_with_quality_feedback(self):
        ...
        print(f"✅ Quality feedback test passed - Quality gate: {result.metadata['quality_gate_passed']}")
    ...
    def test_next_step_low_quality_handling(self):
        ...
        print(f"✅ Low quality handling test passed - Improvement suggested: {result.step}")
    ...
    def test_next_step_context_management(self):
        ...
        print(f"✅ Context management test passed - Context keys: {len(result.context)}")
    ...
    def test_next_step_template_selection(self):
        ...
        print(f"✅ Template selection test passed - Template: {result.metadata['template_selected']}")
    ...
    def test_next_step_error_handling(self):
        ...
        assert "会话恢复" in result.prompt_template or "session" in result.prompt_template.lower()
    ...
    def test_next_step_step_result_saving(self):
        ...
        print(f"✅ Step result saving test passed - Results saved for: {current_step_before}")
    ...
    def test_next_step_instructions_generation(self):
        ...
        print("✅ Instructions generation test passed - Contextual instructions generated")
    ...
    def test_next_step_metadata_completeness(self):
        ...
        print(f"✅ Metadata completeness test passed - All {len(expected_fields)} fields present")
