...
class TestMCPModels:
    ...
    def test_start_thinking_input(self):
        ...
        input_data = StartThinkingInput(
            topic="如何提高学习效率？", complexity="moderate", focus="学生群体"
        )
...
class TestSessionManager:
    ...
    def test_add_step_result(self):
        ...
        self.session_manager.add_step_result(
            "test-003", "step1", "Step completed successfully", quality_score=0.85
        )
...
class TestMCPTools:
    ...
    def test_start_thinking(self):
        ...
        input_data = StartThinkingInput(
            topic="如何提高团队协作效率？", complexity="complex", focus="远程工作"
        )
    ...
    def test_complete_thinking(self):
        ...
        complete_input = CompleteThinkingInput(
            session_id=start_result.session_id, final_insights="测试洞察"
        )
...
class TestErrorHandling:
    ...
    def test_deep_thinking_error(self):
        ...
        error = DeepThinkingError(
            "Test error message", error_code="TEST_001", details={"test": True}
        )
